...
sanitize_all_json_files(inputs_dir="src/rag/outputs/English Transcripts from Youtube", outputs_dir="src/rag/outputs/English Transcripts from Youtube/sanitized", batch_size=10)